...
import com.fbty.base.util.DataBaseHelper;
import com.fbty.base.util.DateTools;
			...
			for (int i = 0; i < length; i++) {
				...
				if (null != db_data) {
					...
					if ("String".equals(fieldTypeName)) {
						...
						BeanTools.setFieldValue(entity, fieldName[i],DateTools.parse(db_data,GrimpConstants.DATE_FORMAT_STRING));
