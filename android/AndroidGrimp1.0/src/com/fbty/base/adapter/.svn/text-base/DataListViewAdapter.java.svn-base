...
public class DataListViewAdapter extends BaseAdapter {
	...
	public DataListViewAdapter(Context context,ArrayList<HashMap<String,Object>> list,int resource,String[] from,int[] to){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Log.d("DataListViewAdapter","list长度"+list.size());
		return convertView;
	}
