 ...
 */
package com.fbty.androidgrimp.hjdz;
 ...
 * 
 */
public class HjdzMenuActivity extends BaseSuperTreeMenuActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		setTitle(R.string.hjdz_info);
		Resources res = getResources();
		parent = res.getStringArray(R.array.hjdz_item_parent);
		String[][] tempChild = { res.getStringArray(R.array.hjdz_item_child1),
				res.getStringArray(R.array.hjdz_item_child2) };
		child = tempChild;
		String[][][] tempGrandson = {
				{ res.getStringArray(R.array.hjdz_item_grandson1_1),
						res.getStringArray(R.array.hjdz_item_grandson1_2) },
				{ res.getStringArray(R.array.hjdz_item_grandson2_1) } };
