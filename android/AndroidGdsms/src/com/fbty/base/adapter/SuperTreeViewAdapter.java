...
import com.fbty.base.util.SuperTreeNode;
import com.fbty.base.util.TreeNode;
...
public class SuperTreeViewAdapter extends BaseExpandableListAdapter {
	...
	public Object getChild(int groupPosition, int childPosition) {
		return superTreeNodes.get(groupPosition).getChilds().get(childPosition);
	}

	public int getChildrenCount(int groupPosition) {
		return superTreeNodes.get(groupPosition).getChilds().size();
	}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		treeView.setOnGroupExpandListener(new OnGroupExpandListener() {
			...
			public void onGroupExpand(int groupPosition) {
				...
				AbsListView.LayoutParams lp = new AbsListView.LayoutParams(
						ViewGroup.LayoutParams.FILL_PARENT, (treeNode
								.getChilds().size() + 1)
	...
	public Object getGroup(int groupPosition) {
		return superTreeNodes.get(groupPosition).getParent();
	}
